...
//
// dvcPointsCalculator service type conversion functions
//
// Command:
...
func (t *DvcpointcalculatorResort) CreateFromResort(v *model.Resort) {
	temp := &DvcpointcalculatorResort{
		Name: &v.Name,
		Code: &v.Code,
	}
	if v.RoomTypes != nil {
...
func (t *DvcpointcalculatorResort) CreateFromResort2(v *model.Resort) {
	temp := &DvcpointcalculatorResort{
		Name: &v.Name,
		Code: &v.Code,
	}
