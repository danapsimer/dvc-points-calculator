...
// New instantiates HTTP handlers for all the Points service endpoints using
...
func (s *Server) Service() string { return "Points" }
...
// MountGetResortsHandler configures the mux to serve the "Points" service
// "GetResorts" endpoint.
func MountGetResortsHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/resort", f)
}

// NewGetResortsHandler creates a HTTP handler which loads the HTTP request and
// calls the "Points" service "GetResorts" endpoint.
func NewGetResortsHandler(
	...
	var (
		encodeResponse = EncodeGetResortsResponse(encoder)
		encodeError    = goahttp.ErrorEncoder(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "GetResorts")
...
// MountGetResortHandler configures the mux to serve the "Points" service
// "GetResort" endpoint.
func MountGetResortHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("GET", "/resort/{resortCode}", f)
}

// NewGetResortHandler creates a HTTP handler which loads the HTTP request and
// calls the "Points" service "GetResort" endpoint.
func NewGetResortHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeGetResortRequest(mux, decoder)
		encodeResponse = EncodeGetResortResponse(encoder)
		encodeError    = EncodeGetResortError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
...
// MountGetResortYearHandler configures the mux to serve the "Points" service
// "GetResortYear" endpoint.
func MountGetResortYearHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("GET", "/resort/{resortCode}/year/{year}", f)
}

// NewGetResortYearHandler creates a HTTP handler which loads the HTTP request
// and calls the "Points" service "GetResortYear" endpoint.
func NewGetResortYearHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeGetResortYearRequest(mux, decoder)
		encodeResponse = EncodeGetResortYearResponse(encoder)
		encodeError    = EncodeGetResortYearError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "GetResortYear")
		ctx = context.WithValue(ctx, goa.ServiceKey, "Points")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil {
...
// MountGetPointChartHandler configures the mux to serve the "Points" service
// "GetPointChart" endpoint.
func MountGetPointChartHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("GET", "/chart/{resortCode}/{year}", f)
}

// NewGetPointChartHandler creates a HTTP handler which loads the HTTP request
// and calls the "Points" service "GetPointChart" endpoint.
func NewGetPointChartHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeGetPointChartRequest(mux, decoder)
		encodeResponse = EncodeGetPointChartResponse(encoder)
		encodeError    = EncodeGetPointChartError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
